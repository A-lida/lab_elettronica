...
\begin{document}
    ...
    \begin{table}[!ht]
        ...
        \caption{Misura della caratteristica in uscita del transistor BJT, per una corrente di base pari a $-100$~\textmu A. Si riportano i valori assoluti delle misure, il
        valore di corrente riportato rappresenta la media dei due valori misurati. Si riportano i fondo scala utilizzati e le incertezze associate, il cui calcolo
    ...
    \begin{table}[!ht]
        ...
        \captionsetup{justification=centering} % Opzionale, migliora l'allineamento
        \caption{Misura della caratteristica in uscita del transistor BJT, per una corrente di base pari a $-200$~\textmu A. Si riportano i valori assoluti delle misure, il
        valore di corrente riportato rappresenta la media dei due valori misurati. Si riportano i fondo scala utilizzati e le incertezze associate, il cui calcolo
        è consultabile in Appendice~\ref{sec:propagazione-errori-misure}.}
        \label{tab:200uA}
